...
var UploadComponent = /** @class */ (function () {
    ...
    UploadComponent.prototype.handleKeydown = function (event) {
        ...
        if ((event.keyCode === kendo_angular_common_2.Keys.Enter || event.keyCode === kendo_angular_common_2.Keys.Space) &&
    ...
    UploadComponent.prototype.showTotalStatus = function () {
        var states = [
            file_info_1.FileState.Uploaded,
            file_info_1.FileState.Uploading,
            file_info_1.FileState.Failed
        ];
    ...
    UploadComponent.prototype.subscribeBlur = function () {
        ...
        this._ngZone.runOutsideAngular(function () {
            ...
            _this.blurSubscription = rxjs_1.merge(_this.documentClick, _this.navigation.onTab).subscribe(function () { return _this._ngZone.run(function () {
    ...
    UploadComponent.propDecorators = {
        ...
        hostDefaultClasses: [{ type: core_1.HostBinding, args: ['class.k-widget',] }, { type: core_1.HostBinding, args: ['class.k-upload',] }, { type: core_1.HostBinding, args: ['class.k-header',] }],
