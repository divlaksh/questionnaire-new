...
export declare class UploadComponent implements OnInit, OnDestroy, ControlValueAccessor {
    ...
    constructor(uploadService: UploadService, localization: LocalizationService, navigation: NavigationService, _ngZone: NgZone, renderer: Renderer2, wrapper: ElementRef);
    ngOnInit(): void;
    ngOnDestroy(): void;
    /**
     * @hidden
     ...
     * @hidden
     */
    readonly selectButtonClasses: Object;
    /**
     * @hidden
     */
