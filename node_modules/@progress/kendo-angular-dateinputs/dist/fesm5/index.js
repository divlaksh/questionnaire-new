import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChild, ContentChildren, Directive, ElementRef, EventEmitter, HostBinding, HostListener, Inject, Injectable, InjectionToken, Injector, Input, IterableDiffers, NgModule, NgZone, Optional, Output, Renderer2, TemplateRef, ViewChild, ViewChildren, ViewContainerRef, forwardRef, isDevMode } from '@angular/core';
import { NG_VALIDATORS, NG_VALUE_ACCESSOR, NgControl } from '@angular/forms';
import { ComponentMessages, L10N_PREFIX, LocalizationService, RTL } from '@progress/kendo-angular-l10n';
import { addCenturies, addDays, addDecades, addMonths, addWeeks, addYears, cloneDate, createDate, dayOfWeek, durationInCenturies, durationInDecades, durationInMonths, durationInYears, firstDayOfMonth, firstDecadeOfCentury, firstMonthOfYear, firstYearOfDecade, getDate, isEqual, lastDayOfMonth, lastDecadeOfCentury, lastMonthOfYear, lastYearOfDecade, weekInYear } from '@progress/kendo-date-math';
import { EventsModule, KendoInput, Keys, guid, hasObservers, isDocumentAvailable } from '@progress/kendo-angular-common';
import { IntlModule, IntlService } from '@progress/kendo-angular-intl';
import { BehaviorSubject, EMPTY, Observable, ReplaySubject, Subject, Subscription, animationFrameScheduler, combineLatest, from, fromEvent, interval, merge, of } from 'rxjs';
import { debounceTime, filter, map, scan, takeWhile } from 'rxjs/operators';
...
var CELLS_LENGTH = 5;
var ROWS_LENGTH = 2;
var ACTIONS = (_a = {}, _a[Action.Left] = function (date) { return addDecades(date, -1); }, _a[Action.Up] = function (date) { return addDecades(date, -5); }, _a[Action.Right] = function (date) { return addDecades(date, 1); }, _a[Action.Down] = function (date) { return addDecades(date, 5); }, _a[Action.PrevView] = function (date) { return addCenturies(date, -1); }, _a[Action.NextView] = function (date) { return addCenturies(date, 1); }, _a[Action.FirstInView] = function (date) { return firstDecadeOfCentury(date); }, _a[Action.LastInView] = function (date) { return lastDecadeOfCentury(date); }, _a);
/**
 * @hidden
 */
...
var ROWS_LENGTH$1 = 2;
var ACTIONS$1 = (_a$1 = {}, _a$1[Action.Left] = function (date) { return addYears(date, -1); }, _a$1[Action.Up] = function (date) { return addYears(date, -5); }, _a$1[Action.Right] = function (date) { return addYears(date, 1); }, _a$1[Action.Down] = function (date) { return addYears(date, 5); }, _a$1[Action.PrevView] = function (date) { return addDecades(date, -1); }, _a$1[Action.NextView] = function (date) { return addDecades(date, 1); }, _a$1[Action.FirstInView] = function (date) { return firstYearOfDecade(date); }, _a$1[Action.LastInView] = function (date) { return lastYearOfDecade(date); }, _a$1);
/**
 * @hidden
 */
...
var ROWS_LENGTH$2 = 6;
var ACTIONS$2 = (_a$2 = {}, _a$2[Action.Left] = function (date) { return addDays(date, -1); }, _a$2[Action.Up] = function (date) { return addWeeks(date, -1); }, _a$2[Action.Right] = function (date) { return addDays(date, 1); }, _a$2[Action.Down] = function (date) { return addWeeks(date, 1); }, _a$2[Action.PrevView] = function (date) { return addMonths(date, -1); }, _a$2[Action.NextView] = function (date) { return addMonths(date, 1); }, _a$2[Action.FirstInView] = function (date) { return firstDayOfMonth(date); }, _a$2[Action.LastInView] = function (date) { return lastDayOfMonth(date); }, _a$2);
/**
 * @hidden
 */
...
var ACTIONS$3 = (_a$3 = {}, _a$3[Action.Left] = function (date) { return addMonths(date, -1); }, _a$3[Action.Up] = function (date) { return addMonths(date, upStep(date.getMonth())); }, _a$3[Action.Right] = function (date) { return addMonths(date, 1); }, _a$3[Action.Down] = function (date) { return addMonths(date, downStep(date.getMonth())); }, _a$3[Action.PrevView] = function (date) { return addYears(date, -1); }, _a$3[Action.NextView] = function (date) { return addYears(date, 1); }, _a$3[Action.FirstInView] = function (date) { return firstMonthOfYear(date); }, _a$3[Action.LastInView] = function (date) { return lastMonthOfYear(date); }, _a$3);
/**
 * @hidden
 */
...
var _a$4;
var services = (_a$4 = {}, _a$4[CalendarViewEnum.month] = MonthViewService, _a$4[CalendarViewEnum.year] = YearViewService, _a$4[CalendarViewEnum.decade] = DecadeViewService, _a$4[CalendarViewEnum.century] = CenturyViewService, _a$4);
...
var scrollModifiers = (_a$5 = {}, _a$5[ScrollDirection.Forward] = function (step) { return function (value) { return value + step; }; }, _a$5[ScrollDirection.Backward] = function (step) { return function (value) { return value - step; }; }, _a$5);
var scrollNormalizers = (_b = {}, _b[ScrollDirection.Forward] = function (end) { return function (value) { return Math.min(value, end); }; }, _b[ScrollDirection.Backward] = function (end) { return function (value) { return Math.max(value, end); }; }, _b);
var scrollValidators = (_c = {}, _c[ScrollDirection.Forward] = function (end) { return function (start) { return start < end; }; }, _c[ScrollDirection.Backward] = function (end) { return function (start) { return start > end; }; }, _c);
...
var CalendarComponent = /** @class */ (function () {
    ...
    CalendarComponent.prototype.handleDateChange = function (candidate) {
        ...
        this.ngZone.run(function () {
            ...
            _this.propagateChange(cloneDate(candidate));
...
var DateInputComponent = /** @class */ (function () {
    ...
    DateInputComponent.prototype.ngOnChanges = function (changes) {
        ...
        if ((this.hasChanged(changes, 'min') || this.hasChanged(changes, 'max')) &&
            !changes.value && (!firstChange(changes.min) || !firstChange(changes.max))) {
    ...
    DateInputComponent.prototype.notify = function () {
        var _this = this;
        this.ngZone.run(function () {
            _this.ngChange(cloneDate(_this.value));
...
var CalendarModule = /** @class */ (function () {
    ...
    CalendarModule.decorators = [
        { type: NgModule, args: [{
                    ...
                    exports: [COMPONENT_DIRECTIVES$3, CalendarCommonModule, TemplatesModule],
...
var MultiViewCalendarModule = /** @class */ (function () {
    ...
    MultiViewCalendarModule.decorators = [
        { type: NgModule, args: [{
                    declarations: [COMPONENT_DIRECTIVES$4],
                    exports: [COMPONENT_DIRECTIVES$4, CalendarCommonModule, TemplatesModule],
...
var DateInputModule = /** @class */ (function () {
    ...
    DateInputModule.decorators = [
        { type: NgModule, args: [{
                    declarations: [COMPONENT_DIRECTIVES$5],
                    exports: [COMPONENT_DIRECTIVES$5],
 ...
 * @hidden
 */
var Messages$3 = /** @class */ (function (_super) {
    __extends(Messages, _super);
    function Messages() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
 ...
 * @hidden
 */
var LocalizedMessagesDirective$3 = /** @class */ (function (_super) {
    __extends(LocalizedMessagesDirective, _super);
    function LocalizedMessagesDirective(service) {
        var _this = _super.call(this) || this;
        _this.service = service;
...
var DatePickerModule = /** @class */ (function () {
    ...
    DatePickerModule.decorators = [
        { type: NgModule, args: [{
                    declarations: [COMPONENT_DIRECTIVES$6],
                    exports: [COMPONENT_DIRECTIVES$6, TemplatesModule],
                    imports: [CommonModule].concat(COMPONENT_MODULES$1),
                    providers: [{ provide: TOUCH_ENABLED, useValue: ɵ0$13 }]
                },] },
    ];
    return DatePickerModule;
}());

var COMPONENT_DIRECTIVES$7 = [
    DateRangeComponent,
...
var DateRangeModule = /** @class */ (function () {
    ...
    DateRangeModule.decorators = [
        { type: NgModule, args: [{
                    declarations: [COMPONENT_DIRECTIVES$7],
                    exports: [COMPONENT_DIRECTIVES$7],
 ...
 * @hidden
 */
var DOMService$1 = /** @class */ (function () {
    function DOMService() {
    }
    DOMService.prototype.ensureHeights = function () {
...
var services$1 = (_a$6 = {}, _a$6[TIME_PART.dayperiod] = DayPeriodService, _a$6[TIME_PART.hour] = HoursService, _a$6[TIME_PART.minute] = MinutesService, _a$6[TIME_PART.second] = SecondsService, _a$6);
/**
 * @hidden
 */
...
var ɵ3$7 = function (value) { return value.getHours(); };
var ɵ4$2 = function (_, min) { return min.getHours(); };
var ɵ5$1 = function (value) { return value.getMinutes(); };
var ɵ6$1 = function (value, min) { return isEqualTillMinute(value, min) ? min.getMinutes() : 0; };
var ɵ7$1 = function (value) { return value.getSeconds(); };
var ɵ8$1 = function (value, min) { return isEqualTillSecond(value, min) ? min.getSeconds() : 0; };
var ɵ9$1 = function (value) { return value.getMilliseconds(); };
var ɵ10$1 = function (value, min) { return isEqualTillMillisecond(value, min) ? min.getMilliseconds() : 0; };
var defaultGetters = [
    {
        type: TIME_PART.hour,
        getter: ɵ3$7,
 ...
 * @hidden
 */
var Messages$4 = /** @class */ (function (_super) {
    __extends(Messages, _super);
    function Messages() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
 ...
 * @hidden
 */
var LocalizedMessagesDirective$4 = /** @class */ (function (_super) {
    __extends(LocalizedMessagesDirective, _super);
    function LocalizedMessagesDirective(service) {
        var _this = _super.call(this) || this;
        _this.service = service;
...
var COMPONENT_DIRECTIVES$8 = [
    LocalizedMessagesDirective$4,
    TimeListComponent,
...
var TimePickerModule = /** @class */ (function () {
    ...
    TimePickerModule.decorators = [
        { type: NgModule, args: [{
                    declarations: [COMPONENT_DIRECTIVES$8],
                    exports: [COMPONENT_DIRECTIVES$8],
                    imports: [CommonModule].concat(COMPONENT_MODULES$3),
                    providers: providers
                },] },
    ];
...
var DateInputsModule = /** @class */ (function () {
    ...
    DateInputsModule.decorators = [
        { type: NgModule, args: [{
                    exports: COMPONENT_MODULES$4,
                    imports: COMPONENT_MODULES$4
                },] },
    ];
...
export { CalendarCommonModule, CALENDAR_RANGE_VALIDATORS, CALENDAR_VALUE_ACCESSOR, KENDO_INPUT_PROVIDER, KForOf, KForOfContext, HeaderComponent, HorizontalViewListComponent, Messages, LocalizedMessagesDirective, MultiViewCalendarCustomMessagesComponent, LocalizedMessagesDirective$1, Messages$1, MultiViewCalendarComponent, RANGE_CALENDAR_RANGE_VALIDATORS, RANGE_CALENDAR_VALUE_ACCESSOR, NavigationComponent, BusViewService, CenturyViewService, DecadeViewService, DOMService, MonthViewService, NavigationService, ScrollSyncService, WeekNamesService, YearViewService, TemplatesModule, CellTemplateDirective, CenturyCellTemplateDirective, DecadeCellTemplateDirective, HeaderTitleTemplateDirective, MonthCellTemplateDirective, NavigationItemTemplateDirective, WeekNumberCellTemplateDirective, YearCellTemplateDirective, ViewListComponent, ViewComponent, PickerService, LocalizedMessagesDirective$2, Messages$2, LocalizedMessagesDirective$3, Messages$3, DateRangeInput, DateRangePopupTemplateDirective, browser, detectDesktopBrowser, detectMobileOS, mobileOS, msPointers, pointers, touch, touchEnabled, LocalizedMessagesDirective$4, Messages$4, TimePickerCustomMessagesComponent, TimeSelectorCustomMessagesComponent, TimeSelectorLocalizedMessagesDirective, DayPeriodService, DOMService$1, HoursService, MinutesService, SecondsService, TimeListComponent, TimeSelectorComponent, TOUCH_ENABLED, isWindowAvailable, ScrollerService, DEFAULT_SCROLLER_FACTORY, SCROLLER_FACTORY_TOKEN, VirtualizationComponent, VirtualizationModule, CalendarComponent, DateInputComponent, DatePickerComponent, TimePickerComponent, DateRangeComponent, DateRangePopupComponent, DateRangeEndInputDirective, DateRangeStartInputDirective, DateRangeSelectionDirective, CalendarModule, CalendarsModule, DateInputModule, DatePickerModule, DateInputsModule, TimePickerModule, MultiViewCalendarModule, DateRangeModule, DateRangeService, CalendarCustomMessagesComponent, DateInputCustomMessagesComponent, DatePickerCustomMessagesComponent, PreventableEvent };
