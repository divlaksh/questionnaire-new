...
class CalendarComponent {
    constructor(bus, dom, element, navigator, renderer, cdr, ngZone, injector, scrollSyncService, pickerService) {
        this.bus = bus;
        this.dom = dom;
...
const firstChange = (change) => change ? change.firstChange : true;
...
class DateInputComponent {
    ...
    ngOnChanges(changes) {
        ...
        if ((this.hasChanged(changes, 'min') || this.hasChanged(changes, 'max')) &&
            ...
            this.resolvedPromise.then(() => this.ngChange(cloneDate(this.value)));
        }
        if (changes.format) {
            this.symbolsMap = this.dateSymbolMap();
            this.updateFormatSections();
...
class MultiViewCalendarComponent {
    constructor(bus, element, localization, navigator, renderer, cdr, zone) {
        this.bus = bus;
        this.element = element;
        this.localization = localization;
        this.navigator = navigator;
...
class DateRangeInput {
    ...
    init() {
        ...
        [
            ...
            this.input.onFocus.subscribe(() => this.activate()),
            this.input.valueChange.subscribe(value => this.updateRange(value, 'change')),
    ...
    initPopup(popup) {
        ...
        [
            ...
            popup.open.subscribe(() => this.toggleActiveClass(this.isActiveEnd)),
 ...
 */
class ViewComponent {
    constructor(bus, intl, cdr, weekService, element, zone, renderer) {
        this.bus = bus;
        this.intl = intl;
        this.cdr = cdr;
 ...
 */
class CalendarCustomMessagesComponent extends Messages {
    constructor(service) {
        super();
        this.service = service;
    }
 ...
 * @hidden
 */
class LocalizedMessagesDirective$2 extends Messages$2 {
    constructor(service) {
        super();
        this.service = service;
    }
 ...
 * Custom component messages override default component messages ([see example]({% slug globalization_dateinputs %}#toc-custom-messages)).
 */
class DateInputCustomMessagesComponent extends Messages$2 {
    constructor(service) {
        super();
        this.service = service;
    }
 ...
 * @hidden
 */
class Messages$3 extends ComponentMessages {
}
Messages$3.propDecorators = {
    today: [{ type: Input }],
    toggle: [{ type: Input }]
};
 ...
 * @hidden
 */
class LocalizedMessagesDirective$3 extends Messages$3 {
    constructor(service) {
        super();
        this.service = service;
    }
}
LocalizedMessagesDirective$3.decorators = [
    { type: Directive, args: [{
                providers: [
                    {
                        provide: Messages$3,
                        useExisting: forwardRef(() => LocalizedMessagesDirective$3) // tslint:disable-line:no-forward-ref
                    }
                ],
...
/** @nocollapse */
LocalizedMessagesDirective$3.ctorParameters = () => [
    { type: LocalizationService }
];
 ...
 * Custom component messages override default component messages ([see example]({% slug globalization_dateinputs %}#toc-custom-messages)).
 */
class DatePickerCustomMessagesComponent extends Messages$3 {
    constructor(service) {
        super();
        this.service = service;
    }
...
const ɵ4$2 = (_, min) => min.getHours();
const ɵ5$1 = (value) => value.getMinutes();
const ɵ6$1 = (value, min) => isEqualTillMinute(value, min) ? min.getMinutes() : 0;
const ɵ7$1 = (value) => value.getSeconds();
const ɵ8$1 = (value, min) => isEqualTillSecond(value, min) ? min.getSeconds() : 0;
const ɵ9$1 = (value) => value.getMilliseconds();
const ɵ10$1 = (value, min) => isEqualTillMillisecond(value, min) ? min.getMilliseconds() : 0;
...
class TimeSelectorComponent {
    ...
    verifyFormat() {
        this.dateFormatParts.forEach(part => {
 ...
 * @hidden
 */
class Messages$4 extends ComponentMessages {
}
Messages$4.propDecorators = {
    accept: [{ type: Input }],
 ...
 * @hidden
 */
class LocalizedMessagesDirective$4 extends Messages$4 {
    constructor(service) {
        super();
        this.service = service;
    }
}
LocalizedMessagesDirective$4.decorators = [
    { type: Directive, args: [{
                providers: [
                    {
                        provide: Messages$4,
                        useExisting: forwardRef(() => LocalizedMessagesDirective$4) // tslint:disable-line:no-forward-ref
                    }
                ],
...
/** @nocollapse */
LocalizedMessagesDirective$4.ctorParameters = () => [
    { type: LocalizationService }
];
 ...
 * Custom component messages override default component messages ([see example]({% slug globalization_dateinputs %}#toc-custom-messages)).
 */
class TimePickerCustomMessagesComponent extends Messages$4 {
    constructor(service) {
        super();
        this.service = service;
    }
 ...
 * @hidden
 */
class TimeSelectorLocalizedMessagesDirective extends Messages$4 {
    constructor(service) {
        super();
        this.service = service;
    }
 ...
 */
class TimeSelectorCustomMessagesComponent extends Messages$4 {
    constructor(service) {
        super();
        this.service = service;
    }
...
TimePickerModule.decorators = [
    { type: NgModule, args: [{
                ...
                imports: [CommonModule, ...COMPONENT_MODULES$3],
                providers: providers
            },] },
];

const COMPONENT_MODULES$4 = [
    CalendarsModule,
    DateInputModule,
    DatePickerModule,
    TimePickerModule,
