...
var DateRangePopupComponent = /** @class */ (function () {
    ...
    DateRangePopupComponent.prototype._toggle = function (show) {
        ...
        if (this._show) {
            ...
            this.addSubscriptions(rxjs_1.fromEvent(popupElement, 'keydown').subscribe(this.handleKeydown.bind(this)), rxjs_1.fromEvent(popupElement, 'mouseleave').subscribe(this.handleMouseLeave.bind(this)), popupAnchorViewportLeave.subscribe(function () { return _this.cancelPopup(); }), popupClose.subscribe(function () { return _this.close.emit(); }), popupOpen.subscribe(function () { return _this.open.emit(); }));
        }
    };
