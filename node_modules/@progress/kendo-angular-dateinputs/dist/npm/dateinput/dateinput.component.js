...
var DateInputComponent = /** @class */ (function () {
    ...
    DateInputComponent.prototype.ngOnChanges = function (changes) {
        ...
        if ((this.hasChanged(changes, 'min') || this.hasChanged(changes, 'max')) &&
            ...
            this.resolvedPromise.then(function () { return _this.ngChange(kendo_date_math_1.cloneDate(_this.value)); });
        }
        if (changes.format) {
            this.symbolsMap = this.dateSymbolMap();
            this.updateFormatSections();
    ...
    DateInputComponent.prototype.writeValue = function (value) {
        ...
        this.value = kendo_date_math_1.cloneDate(value);
        this.valueUpdate.emit(kendo_date_math_1.cloneDate(value)); //TODO: check if we need to move it to `value` setter
        this.updateElementValue(this.isActive);
    };
    /**
     * @hidden
    ...
    DateInputComponent.prototype.notify = function () {
        ...
        this.ngZone.run(function () {
            _this.ngChange(kendo_date_math_1.cloneDate(_this.value));
    ...
    DateInputComponent.prototype.hasChanged = function (changes, field) {
        ...
        return change && !kendo_date_math_1.isEqual(change.previousValue, change.currentValue);
    };
