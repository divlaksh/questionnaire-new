...
var TimePickerComponent = /** @class */ (function () {
    ...
    TimePickerComponent.prototype.handleChange = function (value) {
        ...
        this.zone.run(function () {
            _this.focusInput();
            _this.show = false;
            _this.onChange(kendo_date_math_1.cloneDate(value));
    ...
    TimePickerComponent.propDecorators = {
        ...
        wrapperClasses: [{ type: core_1.HostBinding, args: ['class.k-widget',] }, { type: core_1.HostBinding, args: ['class.k-timepicker',] }, { type: core_1.HostBinding, args: ['class.k-header',] }],
