...
var SortableService = /** @class */ (function () {
    function SortableService(ngZone) {
        ...
        this.subscriptions = this.onPressSubject.pipe(operators_1.filter(allowDrag), operators_1.tap(function (press) {
            ...
            return _this.onDragSubject.pipe(operators_1.filter(function (_) { return !!_this.targetSortable; }), //stop further events if dragStart is prevented
            operators_1.filter(function (_) { return _this.source !== null; }), operators_1.tap(function (e) { return _this.drag(e); }));
        })).subscribe();
    }
    ...
    SortableService.prototype.start = function (event) {
        ...
        this.ngZone.run(function () {
            var startTarget = util_1.draggableFromEvent(event, _this.targetSortable.component);
