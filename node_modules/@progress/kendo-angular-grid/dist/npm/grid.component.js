...
var GridComponent = /** @class */ (function () {
    ...
    GridComponent.prototype.focusEditElement = function (containerSelector) {
        ...
        this.ngZone.runOutsideAngular(function () {
            _this.ngZone.onStable.asObservable().pipe(operators_1.take(1)).subscribe(function () {
    ...
    GridComponent.prototype.navigationMetadata = function () {
        ...
        return new navigation_metadata_1.NavigationMetadata(dataRows, headerRows, isVirtual, this.showPager, this.wrapper);
    };
