...
import { DateRange, Group, NavigationAction, Resource, SchedulerModelFields, SchedulerView, EditMode, CrudOperation, EditableSettings, CurrentTimeSettings, SlotClassArgs } from './types';
...
export declare class SchedulerComponent implements AfterContentInit, OnDestroy, OnInit {
    ...
    resources: Resource[];
    /**
     * Specifies if the Scheduler will display the loading indicator.
     */
    loading: boolean;
    /**
