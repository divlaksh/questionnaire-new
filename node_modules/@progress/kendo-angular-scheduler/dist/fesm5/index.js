...
import { ResizeSensorComponent, ResizeSensorModule, anyChanged, guid, hasObservers, isChanged, isDocumentAvailable } from '@progress/kendo-angular-common';
...
var SchedulerComponent = /** @class */ (function () {
    ...
    SchedulerComponent.prototype.ngOnChanges = function (changes) {
        ...
        if (anyChanged(['group', 'resources', 'min', 'max', 'showWorkHours', 'startTime', 'scrollTime', 'endTime', 'eventHeight',
            ...
            'editable', 'timezone', 'slotClass', 'slotFill', 'columnWidth'], changes)) {
...
var AgendaListComponent = /** @class */ (function () {
    ...
    AgendaListComponent.prototype.getSlotClass = function (item) {
        if (this.slotClass) {
            var dataItem = this.extractDataItem(item);
            ...
            events.forEach(function (event) {
                ...
                if (!event.rect) {
                    ...
                    if (overlaps && overlaps.rect.left > origin) {
                        ...
                        while (overlaps) {
                            overlaps.rect.width = Math.floor(eventWidths[overlaps.item.index] * slotWidth);
...
var RecurrenceEndRuleEditorComponent = /** @class */ (function () {
    ...
    RecurrenceEndRuleEditorComponent.prototype.onUntilBlur = function () {
        if (!isPresent(this.untilValue)) {
            this.untilValue = this.createUntil(this.recurrence.start);
        }
    };
